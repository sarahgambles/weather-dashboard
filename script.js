...
function getCities() {
    ...
    fetch("https://api.openweathermap.org/data/2.5/weather?q=" + search + "&2efddecb7893bc632bfd32ea7419cf75")
    // add my own api key
...
// function forecast() {
//     fetch("api.openweathermap.org/data/2.5/forecast?q={city name}&appid={your api key}")
// }
